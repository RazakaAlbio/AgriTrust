...
export function generateCertificatePDF(data: CertificateData) {
  ...
  doc.text("Data integrity verified via Polygon Amoy blockchain. Tamper-proof and immutable.", 20, oy + 5);
  doc.text("Price Reference: Panel Harga Pangan Bapanas & PIHPS Nasional (2024-2025).", 20, oy + 10);
